...
export async function createCanteen(canteen_name, canteen_location, opening_time, closing_time) {
    ...
    const result = await pool(sql, [canteen_name, canteen_location, opening_time, closing_time]);
    return result;
}
...
export async function openCanteen(canteen_id, is_open) {
    ...
    const result = await pool(sql, [canteen_id, is_open]);
    return result;
}