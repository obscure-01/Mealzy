...
export async function createItem(canteen_id, item_name, description, price, image_url, category, is_vegetarian) {
    const sql = "INSERT INTO items (canteen_id, item_name, description, price, image_url, category, is_vegetarian) VALUES ($1,$2,$3,$4,$5,$6,$7)";
    const result = await pool.query(sql, [canteen_id, item_name, description, price, image_url, category, is_vegetarian]);
    return result;
}
