...
export const TodaysSpecialCard = React.memo(({
  ...
  return (
    <TouchableOpacity
      ...
      disabled={!onPress}
    >
      <View className={`w-full bg-surface-container-lowest rounded-3xl overflow-hidden shadow-[0px_4px_20px_rgba(44,62,80,0.06)] border border-outline-variant/10 flex-col ${className}`}>
          ...
          <View className="absolute inset-0 bg-black/40 flex-col justify-end p-5">
            <View className="flex-row justify-between items-end">
              ...
              <View className="items-end">
                ...
                <TouchableOpacity className="bg-primary px-5 py-2.5 rounded-2xl shadow-lg mt-2 active-scale" onPress={onPress} activeOpacity={0.8}>
